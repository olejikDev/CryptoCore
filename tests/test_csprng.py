...
def test_key_generation_integration():
    """
    нтеграционный тест с генерацией ключа
    Требование TEST-1: шифрование без ключа -> дешифрование с printed key
    """
    print("=== нтеграционный тест (TEST-1) ===")
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        # звлекаем сгенерированный ключ из вывода
        ...
        with open(plain_file, "rb") as f1, open(dec_file, "rb") as f2:
            ...
            if original == decrypted:
                print("[+] нтеграционный тест пройден успешно!")
...
def test_nist_preparation():
    ...
    print(f"\n[+] нструкции для запуска NIST STS:")
...
def main():
    ...
    tests = [
        ...
        ("нтеграция с CryptoCore (TEST-1)", test_key_generation_integration),
    ]
    ...
    # тоги
    print("\n" + "=" * 70)
    print("ТОГ ТЕСТРОВАНЯ CSPRNG")
    print("=" * 70)

    all_passed = True
    for test_name, passed in results.items():
        status = "✅ УСПЕХ" if passed else "❌ ОШБКА"
