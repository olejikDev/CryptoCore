...
def test_avalanche_effect():
    ...
    for algo_name, algo_class in algorithms:
        ...
        modified_data = b"B" + b"A" * 999  # зменяем только первый байт
...
def test_cli_integration():
    """нтеграционный тест CLI команды dgst"""
    print("=== нтеграционный тест CLI ===")
...
def main():
    ...
    print("=" * 70)
    print("ТЕСТЫ ХЕШ-ФУНКЦЙ (Sprint 4)")
    print("=" * 70)
