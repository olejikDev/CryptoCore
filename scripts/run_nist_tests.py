...
def main():
    ...
    parser.add_argument(
        ...
        help="мя выходного файла (по умолчанию: nist_test_data.bin)"
    )
    ...
    if not nist_path:
        ...
        print("   cd sts-2.1.2")
        print("   make")
        print("4. сполняемый файл будет в sts-2.1.2/assess")
    ...
    # нформация об анализе результатов
    print("\n" + "=" * 70)
    print("АНАЛЗ РЕЗУЛЬТАТОВ NIST STS")
    print("=" * 70)
